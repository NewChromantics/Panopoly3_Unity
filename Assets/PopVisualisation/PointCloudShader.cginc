...
void Vertex_uv_TriangleIndex_To_CloudUvs(Texture2D<float4> Positions,SamplerState PositionsSampler,float2 PositionsTextureSize,float2 VertexUv,float2 PointMapUv,float PointSize,out float3 Position,out float2 ColourUv)
{
	/*
